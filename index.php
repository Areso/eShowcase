...
echo "<div class='tab'>";
echo "<button id='tabCity'    >Main   </button>";
//class='tablinks' onclick='openTab(event,'Main')' 
echo "<button id='tabExplore' >Explore</button>";
//class='tablinks' onclick='openTab(event,'Explore')' 
echo "</div>";
